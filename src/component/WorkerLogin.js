...
const WorkerLogin = () => {
  ...
  const handleProfileClick = () => {
    console.log('Worker:', worker); // Debugging line
  
    if (worker) {
      navigate('/worker/profile', { state: { workerData: worker } });
      console.log('Navigating to profile page'); // Additional log
    } else {
  ...
  return (
    <div className="container mt-5" style={{ backgroundImage: 'url(/login.jpg)', backgroundSize: 'cover', backgroundRepeat: 'no-repeat',height:'750px' }}>
